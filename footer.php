    ...
    <footer id="footer">
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="footer-item P30 bg-4">
                <a href="index-2.html" style="background: url(<?php bloginfo('template_url');?>/images/footer_logo.png);" id="footer-logo" class="site-logo">University</a>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="footer-item footer-item_subscribe P30 bg-1">
                ...
                <p class="el-bottom">&copy; <?php echo Date('Y'); echo " - "; bloginfo('name');?> .All rights reserved</p>
            </div>
        </div>
    </footer>
</div>
...
<script type="text/javascript" src="<?php bloginfo('template_url');?>/js/jquery.superslides.min.js"></script>
...
<!-- / settings_box -->
<script type="text/javascript" src="<?php bloginfo('template_url');?>/settings_box/settings_box.js"></script>
</body>

<!-- Mirrored from idealui.com/tf/university/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Dec 2016 05:56:15 GMT -->
</html>
